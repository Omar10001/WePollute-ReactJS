    ...
    <div className=" App mt-20 px-2.5 w-full flex flex-col">
      ...
      <div className='flex mx-auto justify-around w-full'>
        ...
        <a href='https://github.com/Omar10001/'>
          <img src='https://i.ibb.co/SJqs7KV/1298743-github-git-logo-social-icon.png' alt='instagram' className='w-8 md:w-6 animate__animated animate__bounceInRight mr-4' />
        </a>  
      </div>
      <br/>
      <br/>
